      ...
      <div className="align-element flex justify-center sm:justify-between ">
        <div className="flex gap-x-2 sm:gap-x-8 items-center  ">
          <p className="text-xs sm:text-sm ">
            Hello,<span className="font-roboto font-bold text-base"> Juan</span>
          </p>
          <button class="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-blue-900 rounded-full group bg-gradient-to-br from-sky-400 via-blue-500 to-blue-700  hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-sky-900">
